...
![image](https://user-images.githubusercontent.com/55986045/129895805-fb1fba86-1eb5-4b41-9b8e-8363dca94489.png)
...
![image](https://user-images.githubusercontent.com/55986045/129895992-44f71be1-9cae-4d52-a344-a6467199b572.png)
...
![image](https://user-images.githubusercontent.com/55986045/129896249-5ea938b8-4ad9-436b-a93c-254b57c0f4fc.png)
...
![image](https://user-images.githubusercontent.com/55986045/129896292-87319d97-911e-49e2-95f7-0ac7d4fedcb9.png)
...
![image](https://user-images.githubusercontent.com/55986045/129896426-451bac06-e38c-4c11-af0d-75a58677c4fc.png)
...
* Let's try to understand the output in each of the cases above.
  ...
  * In **case 4**: A function can access a global variable, but the global execution context can't access any local variable.
    ...
    ```
    ![image](https://user-images.githubusercontent.com/55986045/129896540-c8ff0bb6-df16-445d-a5a6-45dd97b242f6.png)
    ![image](https://user-images.githubusercontent.com/55986045/129896574-d1f847c3-4995-452c-a301-7a41f1d87a12.png)
...
![image](https://user-images.githubusercontent.com/55986045/129896646-96e3cc6e-9cfb-4501-9e44-cb2dc7cd1c62.png)
...
![image](https://user-images.githubusercontent.com/55986045/129896700-95940363-5ee6-479c-bec2-b9c2dddde8e5.png)
...
* Lets implement a increment counter button. 
    ...
    - Use closures for data abstraction
        ...
        attachEventList();
        ```
        ![image](https://user-images.githubusercontent.com/55986045/129896880-bd956c2e-155a-421b-9e77-569d55919773.png)
...
* Browser has JS Engine which has Call Stack which has Global execution context, local execution context etc.
  ...
  * Now JS needs some way to connect the callstack with all these superpowers. This is done using Web APIs.
  ![image](https://user-images.githubusercontent.com/55986045/129896929-caab6cbc-3f76-4446-b13d-cc26e9354f96.png)

### WebAPIs
None of the below are part of Javascript! These are extra superpowers that browser has. Browser gives access to JS callstack to use these powers.
![image](https://user-images.githubusercontent.com/55986045/129897009-51ee1fe1-5719-4b56-a386-349439dfefa7.png)
...
* Let's undertand the below code image and its explaination:
    ![image](https://user-images.githubusercontent.com/55986045/129897078-8d67beae-6325-4e3d-b612-97beda5955bd.png)
    * ```js
      console.log("start");
...
* ![image](https://user-images.githubusercontent.com/55986045/129897117-3d69ac7d-65e3-47ed-b542-178a9955bb16.png)

Q: Another example to understand Eventloop & Callback Queue.

See the below Image and code and try to understand the reason:
![image](https://user-images.githubusercontent.com/55986045/129897146-ecd56bac-664e-424d-a847-be696bbcb576.png)
Explaination?
...
![image](https://user-images.githubusercontent.com/55986045/129897202-58d68945-7997-477e-879a-755f416fc344.png)

Microtask Priority Visualization
![image](https://user-images.githubusercontent.com/55986045/129897240-b4b2473d-21b7-4913-81e0-8b9bbdaf289d.png)
...
* Code inside Javascript Engine passes through 3 steps : **Parsing**, **Compilation** and **Execution**
    ...
    ![image](https://user-images.githubusercontent.com/55986045/129897432-3566d2bc-fed6-42cd-b239-49bfa3c92ca9.png)

* Companies use different JS engines and each try to make theirs the best.
    * v8 of Google has Interpreter called Ignition, a compiler called Turbo Fan and garbage collector called Orinoco
    * v8 architecture:
    ![image](https://user-images.githubusercontent.com/55986045/129897478-55870875-a781-4f0b-910f-b35659a7f7b2.png)
...
![image](https://user-images.githubusercontent.com/55986045/129897570-67323ed0-ba7d-494f-ba31-3c7b73d606db.png)
...
<br>
<hr>
* <a href="https://alok722.github.io/namaste-javascript-notes/dist/lectures.html"> Reference</a>
